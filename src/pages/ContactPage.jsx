...
const ContactPage = () => {
  const contactInfo = [
    {
      ...
      label: 'Email',
      value: 'contact@beta.school',
      link: 'mailto:contact@beta.school',
  ...
  const socialMedia = [
    ...
    },
    {
      ...
      url: 'https://instagram.com/beta.school',
    ...
    },
    {
      ...
      url: 'https://tiktok.com/@beta.school',
      bgColor: 'bg-gray-900'
    },
    {
      name: 'YouTube',
  ...
  const faqs = [
    {
      question: 'Bagaimana cara mendaftar sebagai anggota OSIS?',
      answer: 'Anda dapat mendaftar melalui wali kelas atau langsung ke sekretariat OSIS. Periode pendaftaran biasanya dibuka di awal semester.'
    },
    {
      question: 'Apakah ada biaya untuk bergabung?',
      answer: 'Tidak ada biaya pendaftaran untuk menjadi anggota OSIS. Semua kegiatan organisasi dibiayai oleh sekolah.'
    },
    {
      question: 'Kapan rapat rutin OSIS dilaksanakan?',
      answer: 'Rapat rutin OSIS dilaksanakan setiap minggu pertama setiap bulan, pada hari Sabtu pukul 14:00 - 16:00 WIB.'
    }
  ];
  ...
  return (
    <>
      <SEO 
        title="Kontak"
        description="Hubungi kami untuk informasi lebih lanjut tentang organisasi sekolah. Kami siap membantu Anda."
        keywords="kontak OSIS, hubungi kami, alamat sekolah, email OSIS"
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
            ...
            <div>
              ...
              <div className="space-y-6 mb-8">
                ...
                <a 
                  href="https://wa.me/628123456789?text=Halo,%20saya%20ingin%20bertanya%20tentang%20BETA"
                  target="_blank"
